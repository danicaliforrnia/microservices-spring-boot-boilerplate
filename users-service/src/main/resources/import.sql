...
INSERT INTO usr_user (usr_username, usr_full_name, usr_password, usr_is_active, rol_id, usr_is_signed_in, usr_sign_in_at) VALUES ('admin', 'Administrador', '$2a$10$zem6HtkxbJz3lnEdST8Yte9Xd11iFDQyBdB6YdrYt/bjPiouZRZr6', true, 1, 0, NOW())
INSERT INTO usr_user (usr_username, usr_full_name, usr_password, usr_is_active, rol_id, usr_is_signed_in, usr_sign_in_at) VALUES ('johnDoe', 'John Doe', '$2a$10$zem6HtkxbJz3lnEdST8Yte9Xd11iFDQyBdB6YdrYt/bjPiouZRZr6', true, 2, 0, NOW())
